...
brinstar_location_table = {
    ...
    "Brinstar Main Shaft Left Alcove": LocationData("Brinstar Main", AP_MZM_ID_BASE + 4),  #TODO Renamed
...
kraid_location_table = {
    "Kraid Behind Giant Hoppers": LocationData("Kraid Left Shaft", AP_MZM_ID_BASE + 19),  #TODO Renamed
    ...
    "Kraid Zipline Activator Room": LocationData("Kraid Acid Worm Area", AP_MZM_ID_BASE + 29),  #TODO renamed
...
norfair_location_table = {
    "Norfair Lava Dive Left": LocationData("Lower Norfair", AP_MZM_ID_BASE + 32),  #TODO Renamed
    "Norfair Lava Dive Right": LocationData("Lower Norfair", AP_MZM_ID_BASE + 33),  #TODO renamed
    "Norfair Screw Attack": LocationData("Norfair Screw Attack Area", AP_MZM_ID_BASE + 34),
    "Norfair Next to Screw Attack": LocationData("Norfair Screw Attack Area", AP_MZM_ID_BASE + 35),  #TODO renamed
    ...
    "Norfair Bomb Trap": LocationData("Norfair Lower Right Shaft", AP_MZM_ID_BASE + 39),  #TODO may change region
    "Norfair Heated Room Below Wave - Left": LocationData("Lower Norfair", AP_MZM_ID_BASE + 40),  #TODO Renamed
    "Norfair Heated Room Below Wave - Right": LocationData("Lower Norfair", AP_MZM_ID_BASE + 41), #TODO Renamed
    "Norfair Heated Room Under Brinstar Elevator": LocationData("Norfair Lower Right Shaft", AP_MZM_ID_BASE + 42), #TODO may change region
    "Norfair Behind Lower Super Missile Door - Right": LocationData("Norfair Behind Super Door", AP_MZM_ID_BASE + 43), #TODO Renamed
    ...
    "Norfair Larva Ceiling": LocationData("Norfair Bottom", AP_MZM_ID_BASE + 50),  #TODO Renamed
...
ridley_location_table = {
    ...
    "Ridley Behind Unknown Statue": LocationData("Ridley Room", AP_MZM_ID_BASE + 56),  #TODO Renamed
    ...
    "Ridley Upper Ball Cannon Puzzle": LocationData("Central Ridley", AP_MZM_ID_BASE + 59),  #TODO may change region
    "Ridley Lower Ball Cannon Puzzle": LocationData("Central Ridley", AP_MZM_ID_BASE + 60),  #TODO may change region
    ...
    "Ridley Center Pillar": LocationData("Central Ridley", AP_MZM_ID_BASE + 65),  #TODO Renamed
    ...
    "Ridley Fake Lava Under Floor": LocationData("Ridley Right Shaft", AP_MZM_ID_BASE + 68),  #TODO Renamed
    "Ridley Under Owls": LocationData("Central Ridley", AP_MZM_ID_BASE + 69),  #TODO Renamed
...
crateria_location_table = {
    ...
    "Crateria Unknown Item Statue": LocationData("Upper Crateria", AP_MZM_ID_BASE + 79), #TODO renamed
...
chozodia_location_table = {
    ...
    "Chozodia Ruins East of Upper Crateria Door": LocationData("Chozodia Ruins", AP_MZM_ID_BASE + 85),  #TODO renamed
